...
expression_list : expression terminator
                | expression_list expression terminator
                | terminator
                | class_definition terminator
                ;

expression : function_definition
           | function_inline_call
           | function_inline_call_from_class
           | require_block
           | if_statement
           | unless_statement
           | rvalue
...
function_inline_call_from_class : function_call_from_class;
...
class_name: id_class | id_class LESS id_superclass;

class_definition_body: expression_list;
...
function_call_from_class: id_class_fcall DOT name=function_name LEFT_RBRACKET params=function_call_param_list RIGHT_RBRACKET
                          | id_class_fcall DOT name=function_name params=function_call_param_list
                          | id_class_fcall DOT name=function_name LEFT_RBRACKET RIGHT_RBRACKET;
...
function_call_assignment : function_call | function_call_from_class;
...
lvalue : id
       | id_class_var // war vorher | id_global
       | id_instance_var
       ;
...
id_superclass : ID_SUPERCLASS;

id_class_fcall : ID_CLASS_FCALL;
...
ID_CLASS_VAR : '@@'ID ;
ID_INSTANCE_VAR : '@'ID;
ID_CLASS_FCALL : [A-Z_][a-zA-Z0-9_]*;
